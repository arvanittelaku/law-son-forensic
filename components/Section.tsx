...
export function Section({ children, alt = false, className = "", id }: SectionProps) {
  return (
    <section
      id={id}
      className={`py-10 sm:py-14 md:py-20 ${alt ? "bg-section-alt" : "bg-white"} ${className}`}
    >
